...
// Para permitir apenas uma URL específica, você pode usar a seguinte configuração comentada:
/* app.use(cors({
     origin: 'https://luck-royal-drum.glitch.me/' // Substitua pela URL permitida
 })); */
...
app.get("/user/:id", checkToken, async (req, res) => {
    ...
    // Check if user exists - checando usuário
