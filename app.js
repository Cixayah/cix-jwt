...
// CORS para desenvolvimento (qualquer origem)
app.use(cors());

// Para produção, use CORS restrito:
...
// Middleware para checar o token JWT
...
// Rota privada: dados do usuário por ID
...
// Rota privada: dados do usuário autenticado
...
app.post('/auth/register', async (req, res) => {
    ...
    if (password !== confirmPassword) return res.status(422).json({ msg: "A senha não confere!" });
